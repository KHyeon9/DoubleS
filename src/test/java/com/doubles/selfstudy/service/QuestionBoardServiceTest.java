...
class QuestionBoardServiceTest {
    ...
    void 질문_게시글_댓글_생성_성공() {
        ...
        // Then
        assertDoesNotThrow(() -> questionBoardService.createQuestionBoardComment(userId, questionBoard.getId(), comment));
    }
    ...
    void 질문_게시글_댓글_생성시_로그인하지_않은_경우_에러_반환() {
        ...
        // Then
        DoubleSApplicationException e = assertThrows(DoubleSApplicationException.class,
                () -> questionBoardService.createQuestionBoardComment(userId, questionBoard.getId(), comment)
            );
    ...
    void 질문_게시글_댓글_생성시_게시글이_없는_경우_에러_반환() {
        ...
        // Then
        DoubleSApplicationException e = assertThrows(DoubleSApplicationException.class,
                () -> questionBoardService.createQuestionBoardComment(userId, 1L, comment)
        );
